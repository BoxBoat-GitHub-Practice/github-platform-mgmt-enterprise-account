...
module "org_settings" {
  source                                                           = "./github-platform-mgmt-enterprise-account/modules/settings"
...
module "org_actions_settings" {
  source                           = "./github-platform-mgmt-enterprise-account/modules/settings/actions"
  org_allowed_actions              = var.org_allowed_actions
  org_actions_enabled_repositories = var.org_actions_enabled_repositories
  org_actions_github_owned_allowed = var.org_actions_github_owned_allowed
  org_actions_allowed_patterns     = var.org_actions_allowed_patterns
  org_actions_verified_allowed     = var.org_actions_verified_allowed
}
